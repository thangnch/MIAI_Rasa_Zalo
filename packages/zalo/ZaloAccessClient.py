...
from . import ZaloConfig
from . import ZaloClient


class Zalo3rdAppClient(ZaloClient):
    ...
    def get_access_token(self, oauth_code):
        ...
        response = requests.get(url=accesstoken_endpoint, params=params, headers=ZaloConfig.DEFAULT_HEADER)
        return response.json()

    def get(self, url, access_token, params):
        endpoint = "https://graph.zalo.me/" + ZaloConfig.DEFAULT_3RDAPP_API_VERSION + url
